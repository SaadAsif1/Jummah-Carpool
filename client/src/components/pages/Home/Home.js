        ...
        <div className="home-landing-container">
          <div className="home-landing-left animated slideInLeft align-center">
            ...
            <div className="home-sub-text">
              A carpooling website for Muslims. Sign up to offer a ride for
              others, or use our interactive map to find a ride for your next
              jummah.
            </div>
  ...
  return (
    <div className="mission-container">
      ...
      <div className="mission-para">
        Seeing the issues faced by Muslims on their commute to Jummah, we came
        together to help the people find and share rides to their local Jummah.
      </div>
      <div className="mission-para">
        Often we find ourselvse in close proximity with other Jummah-goers, but
        we're unable to pool a ride together. Some of us cannot find a ride, and
        the parking issues that take place at our Masjids are well-known.
      </div>
      <div className="mission-para">
        Jummah Connections is aimed to provide a platform for drivers to earn
        the reward of helping their fellow Muslims fulfill their Jummah
        obligation, and for riders to discover trips in their locality in an
        online, simple and intuitive way, all while reducing CO2 emissions.
      </div>
      <div className="mission-para">
        Our inspiration came from our religion which teaches us the importance
        of Jummah and to take care of our planet. As stated in this Hadith: "The
        world is beautiful and verdant, and verily God, be He exalted, has made
        you His stewards in it, and He sees how you acquit yourselves.” (Muslim)
      </div>
    </div>
  );
};
